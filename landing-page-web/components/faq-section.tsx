...
export default function FAQSection() {
  ...
  return (
    <div className="w-full flex justify-center items-start">
      <div className="w-full  px-4 md:px-20 py-16 md:py-20 flex flex-col lg:flex-row justify-start items-start gap-6 lg:gap-12">
        {/* Left Column - Header */}
        <div className="w-full lg:flex-1 flex flex-col justify-center items-start gap-4 lg:py-5 ml-24">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-5 py-5 flex justify-between items-center gap-5 text-left hover:bg-muted/50 transition-colors duration-200"
